            ...
            <Stack gap={10}>
                <Stack gap={3}>
                    ...
                    <Stack flexDirection="row">
                        <Typography>A public wallet list of wallets entered will be displayed</Typography>
                        <Typography sx={{ color: '#4D82F3' }}>&nbsp;www.link/list.com</Typography>
                    </Stack>
                    <Box
                        sx={{
                ...
                <Stack gap={3}>
                    ...
                    <Stack flexDirection="row" alignItems="center">
                        <Typography>A public winner list of wallets entered will be displayed&nbsp;</Typography>
                        <Typography sx={{ color: '#4D82F3' }}>&nbsp;www.link/list.com</Typography>
                    </Stack>
                    <Box
                        sx={{
