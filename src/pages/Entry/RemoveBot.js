import { Typography, Box, Button, Checkbox, Stack, Slider } from "@mui/material";
                        ...
                        <Stack flexDirection="row" gap={4}>
                            <Button 
                                ...
                                sx={{ 
                                    ...
                                    borderRadius: 3,
                                    py: 1.5
                                }}>0 entries do not have duplicate ip adress</Button>
                            <Button 
                                variant="contained" 
                                size="large"
                                color="error" 
                            ...
                            >0 entries will be disqualified</Button>
                        </Stack>
                    </Stack>
                </Box>
            </Stack>
